...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://files.catbox.moe/2y7lyx.jpeg',
  ...
  BOT_VERSION: '1.0.0V',
  OWNER_NAME: 'TEAM DCT',
  IMAGE_PATH: 'https://files.catbox.moe/2y7lyx.jpeg',
  BOT_FOOTER: '> *©ᴘᴏᴡᴇʀᴅ ʙʏ ✦ ━━ DCT MINI BOT ━━ ✦*',
  BUTTON_IMAGES: { ALIVE: 'https://files.catbox.moe/2y7lyx.jpeg' }
};
// ---------------- MONGO SETUP ----------------
...
// ========== END WORK TYPE RESTRICTIONS ==========
  ...
  try {
    ...
    const OWNER_NAME = config.OWNER_NAME || 'DCT KEZU,DCT MADUSANKA';
...
`;
  ...
  break;
    ...
    let botName = cfg.botName || '✦ ━━ DCT MINI BOT ━━ ✦';
...
🔒 _This menu is restricted to the bot owner only._` 
    ...
    const botName = currentConfig.botName || '✦ ━━ DCT MINI BOT ━━ ✦'; // Default name fallback
...
case 'gpt': {
  try {
    ...
    if (!q) {
      await socket.sendMessage(sender, { 
        text: `*👸 ✦ ━━ DCT MINI BOT ━━ ✦ : 𝙿𝚕𝚎𝚊𝚜𝚎 𝙿𝚛𝚘𝚟𝚒𝚍𝚎 𝙰 𝚀𝚞𝚎𝚜𝚝𝚒𝚘𝚗 !*`,
        buttons: [
    ...
    await socket.sendMessage(sender, { react: { text: '🧠', key: msg.key } });
    await socket.sendMessage(sender, { text: '*👸 ✦ ━━ DCT MINI BOT ━━ ✦ : 𝙰𝙸 𝙸𝚜 𝚃𝚑𝚒𝚗𝚔𝚒𝚗𝚐...*', quoted: metaQuote });
    ...
    ඔයාගේ නම ${botName}. ඔයාගෙන් කවුරුහරි "ඔයාව හැදුවේ කවුද?" හෝ "Who created you?" කියලා ඇහුවොත් පමනක් ඔයා කියන්නේ "මාව හැදුවේ dulina nethmira (DEW CODER TEAM)" කියලා.
    User Question: ${q}`;
    ...
    await socket.sendMessage(sender, { 
      text: '*👸 ✦ ━━ DCT MINI BOT ━━ ✦ : 𝙰𝙿𝙸 𝙴𝚛𝚛𝚘𝚛 𝚃𝚛𝚢 𝙰𝚐𝚊𝚒𝚗 𝙻𝚊𝚝𝚎𝚛 !*',
      buttons: [
        { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📄 𝐌𝐀𝐈𝙽 𝐌𝐄𝐍𝐔' }, type: 1 }
      ]
    }, { quoted: msg });
...
> ✦ ━━ DCT MINI BOT ━━ ✦ 𝐕1 🤍`
                        ...
                        header: {
                            ...
                            subtitle: "✦ ━━ DCT MINI BOT ━━ ✦",
                            hasMediaAttachment: false
                        },
                        contextInfo: {
                            externalAdReply: {
                                title: "✦ ━━ DCT MINI BOT ━━ ✦ UPLOADER",
 ...
 case 'weather':
    try {
        ...
        const messages = {
            ...
            weather: (data) => `
* ✦ ━━ ᴅᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 ᴍᴅ ━━ ✦ ᴡᴇᴀᴛʜᴇʀ ʀᴇᴘᴏʀᴛ *
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯`
                        ...
                        footer: proto.Message.InteractiveMessage.Footer.create({
                            text: "✦ ━━ DCT MINI BOT ━━ ✦ • Secure Connection"
                        }),
...
case 'pp': {
  ...
  case 'cricket':
    try {
        ...
        await socket.sendMessage(sender, {
            text: formatMessage(
                '🏏 ✦ ━━ DCT MINI BOT ━━ ✦ MINI CEICKET NEWS🏏',
                `📢 *${title}*\n\n` +
                `🏆 *mark*: ${score}\n` +
                `🎯 *to win*: ${to_win}\n` +
                `📈 *now speed*: ${crr}\n\n` +
...
*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ${botName}*`,
            contextInfo: {
                externalAdReply: {
                    ...
                    body: "ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ʙʏ ✦ ━━ DCT MINI BOT ━━ ✦",
...
case 'save': {
  try {
    ...
    if (!quotedMsg) {
      return await socket.sendMessage(sender, { text: '*👸 ✦ ━━ DCT MINI BOT ━━ ✦ : 𝙿𝚕𝚎𝚊𝚜𝚎 𝚁𝚎𝚙𝚕𝚢 𝚃𝚘 𝙰 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
    }
    ...
    if (quotedMsg.imageMessage || quotedMsg.videoMessage || quotedMsg.audioMessage || quotedMsg.documentMessage || quotedMsg.stickerMessage) {
      ...
      if (!media || !media.buffer) {
        return await socket.sendMessage(sender, { text: '*👸 ✦ ━━ DCT MINI BOT ━━ ✦ : 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙼𝚎𝚍𝚒𝚊 !*' }, { quoted: msg });
      }

      let captionText = media.caption || '';
      const botCaption = `\n\n👸 *✦ ━━ DCT MINI BOT ━━ ✦ 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥\n\n*✨ 𝙼𝚊𝚍𝚎 𝙱𝚢 🩵 DCT TEAM  🩵*`;
      ...
      if (quotedMsg.imageMessage) {
        ...
        const fname = media.fileName || `✦ ━━ DCT MINI BOT ━━ ✦Saved.${(await FileType.fromBuffer(media.buffer))?.ext || 'bin'}`;
      ...
      await socket.sendMessage(sender, { text: '*👸 ✦ ━━ DCT MINI BOT ━━ ✦ 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 💫\n\n*✅ 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍𝚎𝚍 𝚂𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 !*' }, { quoted: msg });

    } else if (quotedMsg.conversation || quotedMsg.extendedTextMessage) {
      const text = quotedMsg.conversation || quotedMsg.extendedTextMessage.text;
      await socket.sendMessage(saveChat, { text: `👸 *✦ ━━ DCT MINI BOT ━━ ✦ 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥\n\n${text}\n\n*✨ 𝙼𝚊𝚍𝚎 𝙱𝚢 🩵 DCT TEAM  🩵*` });
      ...
      if (typeof socket.copyNForward === 'function') {
        try {
          ...
          await socket.sendMessage(sender, { text: '*👸 ✦ ━━ DCT MINI BOT ━━ ✦ : 𝙴𝚛𝚛𝚘𝚛 𝙵𝚘𝚛𝚠𝚊𝚛𝚍𝚒𝚗𝚐 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 !*' }, { quoted: msg });
        }
      } else {
        await socket.sendMessage(sender, { text: '*👸 ✦ ━━ DCT MINI BOT ━━ ✦ : 𝚄𝚗𝚜𝚞𝚙𝚙𝚘𝚛𝚝𝚎𝚍 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 𝚃𝚢𝚙𝚎 !*' }, { quoted: msg });
      }
    }

  } catch (error) {
    console.error('❌ Save error:', error);
    await socket.sendMessage(sender, { text: '*👸 ✦ ━━ DCT MINI BOT ━━ ✦ : 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝚂𝚊𝚟𝚎 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
  }
  break;
}
case 'alive': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '✦ ━━ DCT MINI BOT ━━ ✦'; // Default fancy name
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
...
┃
╰━━〔 *${config.OWNER_NAME || '✦ ━━ DCT MINI BOT ━━ ✦'}* 〕━━┈⊷
...
END:VCARD` 
    ...
    await socket.sendMessage(sender, {
      image: imagePayload,
      caption: text,
      footer: `*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ✦ ━━ DCT MINI BOT ━━ ✦*`,
      buttons: buttons,
      headerType: 4,
      contextInfo: {
        externalAdReply: {
...
case 'bots': {
  try {
    ...
    await socket.sendMessage(safeSender, { 
        text: `📡 *Connecting to ✦ ━━ DCT MINI BOT ━━ ✦ Server...*
[⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜] 0%`, 
        edit: loadKey 
    });
    ...
    const botName = "✦ ━━ DCT MIN BOT ━━ ✦";
    const defaultLogo = "https://files.catbox.moe/lab4hw.jpeg";
...
╰──────────────────────`;
    ...
    const metaQuote = {
      key: { remoteJid: "status@broadcast", participant: "0@s.whatsapp.net", fromMe: false, id: "✦ ━━ DCT MINI BOT ━━ ✦_STATUS" },
      message: { 
        contactMessage: { 
          displayName: botName, 
          vcard: `BEGIN:VCARD
...
END:VCARD` 
    ...
    await socket.sendMessage(safeSender, {
      image: imagePayload,
      caption: text,
      footer: `👸 ✦ ━━ DCT MINI BOT ━━ ✦ 𝐒𝐘𝐒𝐓𝐄𝐌`,
      contextInfo: {
        externalAdReply: {
          title: `${botName} 𝐌𝐨𝐧𝐢𝐭𝐨𝐫`,
          body: `👸 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 ✦ ━━ DCT MINI BOT ━━ ✦`,
          previewType: "PHOTO",
    ...
    try {
        await socket.sendMessage(sender, { 
            text: '❌ *✦ ━━ DCT MINI BOT ━━ ✦ Error:* An unexpected system error occurred.' 
        }, { quoted: msg });
    } catch (e) {}
  }
  break;
        ...
        const interactiveMsg = generateWAMessageFromContent(sender, {
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: {
                        body: { text: artBody },
                        footer: { text: `Download by ✦ ━━ DCT MINI BOT ━━ ✦` }, // Branding
                        header: {
...
case 'menu1': {
    try {
        ...
        const OWNER_NAME = '✨ DCT KEZU,DCT MADUSANK</> 💻';
        const CHANNEL_LINK = "https://whatsapp.com/channel/0029Vb7p3UCCHDyocfEGm23f";
        const MENU_IMG = "https://files.catbox.moe/2y7lyx.jpeg"; 
...
case 'download': {
  ...
  try {
    ...
    const logos = [
        "https://files.catbox.moe/cy9eam.jpeg", 
        "https://files.catbox.moe/cy9eam.jpeg",
...
case 'creative': {
  ...
  try {
    ...
    // Random Logo Logic
    const logos = [config.LOGO, "https://files.catbox.moe/cy9eam.jpeg"]; // Add more
    const randomLogo = logos[Math.floor(Math.random() * logos.length)] || logos[0];
...
case 'dp': {
    ...
    try {
        ...
        const botName = cfg.botName || "✦ ━━ DCT MINI BOT ━━ ✦"; // Default Artful Name
...
case 'owner': {
  try {
    ...
    const ownerName = 'DCT TEAM';
    const botName = '✦ ━━ DCT MINI BOT ━━ ✦';
    const ownerImage = 'https://files.catbox.moe/cy9eam.jpeg';
    const websiteUrl = 'https://madusankaya-d8eadeadf9e2.herokuapp.com/';
    ...
    const buttonParams = [
      {
        ...
        buttonParamsJson: JSON.stringify({
          ...
          url: `https://wa.me/${ownerNumber}?text=Hello ${ownerName}, I need assistance with ✦ ━━ DCT MINI BOT ━━ ✦ Bot.`
        })
      },
      {
        name: "cta_url",
...
END:VCARD` } }
        ...
        const buttonMessage = {
            ...
            footer: config.FOOTER || '> *✦ ━━ DCT MINI BOT ━━ ✦*',
            buttons: buttons,
             headerType: 4,
            contextInfo: { mentionedJid: [sender] }
        };
...
END:VCARD`
        ...
        const sanitized = (number || '').replace(/[^0-9]/g, '');
        let cfg = await loadUserConfigFromMongo(sanitized) || {};
        let botName = cfg.botName || '✦ ━━ DT MINI BOT ━━ ✦';
...
case 'newslist': {
  try {
    ...
    if (!docs || docs.length === 0) {
      let userCfg = {};
      try { if (number && typeof loadUserConfigFromMongo === 'function') userCfg = await loadUserConfigFromMongo((number || '').replace(/[^0-9]/g, '')) || {}; } catch(e){ userCfg = {}; }
      const title = userCfg.botName || '✦ ━━ ᴅᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 ᴍᴅ ━━ ✦';
      const shonux = {
...
case 'cid': {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    let cfg = await loadUserConfigFromMongo(sanitized) || {};
    let botName = cfg.botName || '✦ ━━ ᴅᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 ᴍᴅ ━━ ✦';
...
case 'tagall': {
  try {
    ...
    let groupPP = 'https://files.catbox.moe/lab4hw.jpeg';
...
case 'admins': {
  try {
    ...
    let userCfg = {};
    try { if (number && typeof loadUserConfigFromMongo === 'function') userCfg = await loadUserConfigFromMongo((number || '').replace(/[^0-9]/g, '')) || {}; } catch(e){ userCfg = {}; }
    const title = userCfg.botName || '✦ ━━ ᴅᴄᴛ ɴᴏᴠᴀ X ᴍᴅ ━━ ✦';
    const shonux = {
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '✦ ━━ ᴅᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 ᴍᴅ ━━ ✦'; // dynamic bot name
...
case 'setbotname': {
  ...
  if (!name) {
    ...
    return await socket.sendMessage(sender, { text: '❗ Provide bot name. Example: `.setbotname ✦ ━━ ᴅᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 ᴍᴅ ━━ ✦`' }, { quoted: shonux });
  }
